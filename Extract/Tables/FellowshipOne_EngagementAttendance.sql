CREATE TABLE [Extract].[FellowshipOne_EngagementAttendance](
...
CREATE CLUSTERED INDEX [CIX_ExtractFellowshipOneEngagementAttendance__ExecutionID] 
	ON [Extract].[FellowshipOne_EngagementAttendance]([ExecutionID] ASC);
GO