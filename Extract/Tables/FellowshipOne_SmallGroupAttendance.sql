CREATE TABLE [Extract].[FellowshipOne_SmallGroupAttendance](
...
CREATE CLUSTERED INDEX [CIX_ExtractFellowshipOneSmallGroupAttendance__ExecutionID] 
	ON [Extract].[FellowshipOne_SmallGroupAttendance]([ExecutionID] ASC);
GO