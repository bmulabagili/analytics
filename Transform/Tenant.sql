CREATE TABLE [Transform].[Tenant] (
    ...
    , CONSTRAINT [PK_TransformTenant__TenantID] 
		PRIMARY KEY CLUSTERED ([TenantID] ASC)
    , CONSTRAINT FK_TransformTenant_ConnectionString__ConnectionStringID
		FOREIGN KEY (ConnectionStringID)
		REFERENCES ConnectionString(ConnectionStringID)
    ,  CONSTRAINT FK_TransformTenant_ETLAction__ETLActionID
