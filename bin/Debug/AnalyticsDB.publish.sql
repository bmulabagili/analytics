...
GO
PRINT N'Creating [Extract].[FellowshipOne_FTVChurchwideService]...';
...
GO
PRINT N'Creating [Extract].[FellowshipOne_FTVChurchwideService].[CIX_ExtractFellowshipOneFTVChurchwideService_ExecutionID]...';


GO
CREATE CLUSTERED INDEX [CIX_ExtractFellowshipOneFTVChurchwideService_ExecutionID]
    ON [Extract].[FellowshipOne_FTVChurchwideService]([ExecutionID] ASC);
...
GO
PRINT N'Creating unnamed constraint on [Extract].[FellowshipOne_FTVChurchwideService]...';
