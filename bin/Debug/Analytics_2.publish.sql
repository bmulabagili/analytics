...
GO
PRINT N'Creating [Extract].[f1_PersonSubStatus]...';
...
GO
PRINT N'Creating [Extract].[f1_PersonSubStatus].[CIX_Extractf1PersonSubStatus__PersonSubStatusID_TenantID]...';


GO
CREATE CLUSTERED INDEX [CIX_Extractf1PersonSubStatus__PersonSubStatusID_TenantID]
    ON [Extract].[f1_PersonSubStatus]([PersonSubStatusID] ASC, [TenantID] ASC);
...
GO
PRINT N'Creating unnamed constraint on [Extract].[f1_PersonSubStatus]...';
