...
GO
PRINT N'Dropping [DW].[DimDate].[IX_DimDate_CalendarMonth]...';


GO
DROP INDEX [IX_DimDate_CalendarMonth]
    ON [DW].[DimDate];
...
GO
ALTER TABLE [DW].[DimDate] DROP CONSTRAINT [DF__DimDate__Inserte__19DFD96B];
...
GO
ALTER TABLE [DW].[DimDate] DROP CONSTRAINT [DF__DimDate__Updated__1AD3FDA4];
...
GO
/*
The column [DW].[DimDate].[DayOfWeek] is being dropped, data loss could occur.

The column [DW].[DimDate].[DayOfWeekAbbreviation] is being dropped, data loss could occur.

The column [DW].[DimDate].[DayOfWeekLabel] is being dropped, data loss could occur.
*/
GO
PRINT N'Starting rebuilding table [DW].[DimDate]...';
...
CREATE TABLE [DW].[tmp_ms_xx_DimDate] (
    [DateID]                        INT           NOT NULL,
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK_DWDimDate__DateID] PRIMARY KEY CLUSTERED ([DateID] ASC)
);

IF EXISTS (SELECT TOP 1 1 
           FROM   [DW].[DimDate])
    BEGIN
        INSERT INTO [DW].[tmp_ms_xx_DimDate] ([DateID], [ActualDateLabel], [ActualDate], [CalendarDayOfMonth], [CalendarDayOfYear], [CalendarLastDayOfMonthFlag], [CalendarMonth], [CalendarMonthAbbreviation], [CalendarMonthLabel], [CalendarQuarter], [CalendarQuarterLabel], [CalendarWeek], [CalendarWeekStartLabel], [CalendarWeekEndLabel], [CalendarYear], [CalendarYearLabel], [DateDescription], [FiscalDayOfWeek], [FiscalDayOfMonth], [FiscalDayOfYear], [FiscalMonth], [FiscalMonthAbbreviation], [FiscalMonthLabel], [FiscalQuarter], [FiscalQuarterLabel], [FiscalWeek], [FiscalWeekStartLabel], [FiscalWeekEndLabel], [FiscalYear], [FiscalYearLabel], [HolidayFlag], [WeekendFlag], [ExecutionID], [InsertedDateTime], [UpdatedDateTime], [Hashvalue])
        SELECT   [DateID],
                 [ActualDateLabel],
                 [ActualDate],
                 [CalendarDayOfMonth],
                 ...
                 [FiscalDayOfYear],
                 [FiscalMonth],
                 [FiscalMonthAbbreviation],
                 [FiscalMonthLabel],
                 [FiscalQuarter],
                 [FiscalQuarterLabel],
                 [FiscalWeek],
                 [FiscalWeekStartLabel],
                 [FiscalWeekEndLabel],
                 [FiscalYear],
                 [FiscalYearLabel],
                 [HolidayFlag],
...
EXECUTE sp_rename N'[DW].[tmp_ms_xx_DimDate]', N'DimDate';

EXECUTE sp_rename N'[DW].[tmp_ms_xx_constraint_PK_DWDimDate__DateID]', N'PK_DWDimDate__DateID', N'OBJECT';
...
GO
PRINT N'Creating [DW].[FactFinancialOther]...';
...
CREATE TABLE [DW].[FactFinancialOther] (
    ...
    CONSTRAINT [pk_DWFactFinancialOther__FinancialOtherID_TenantID] PRIMARY KEY CLUSTERED ([FinancialOtherID] ASC, [TenantID] ASC)
);


GO
PRINT N'Creating [DW].[FactHCAMetric]...';
...
CREATE TABLE [DW].[FactHCAMetric] (
    ...
    [UpdatedDateTime]  DATETIME       NULL,
    [Hashvalue]        NVARCHAR (64)  NOT NULL,
    CONSTRAINT [pk_DWFactHCAMetric__HCAMetricID_TenantID] PRIMARY KEY CLUSTERED ([HCAMetricID] ASC, [TenantID] ASC)
);


GO
PRINT N'Creating [Transform].[FactFinancialOther]...';
...
CREATE TABLE [Transform].[FactFinancialOther] (
    ...
    [UpdatedDateTime]     DATETIME      NULL,
    [Hashvalue]           NVARCHAR (64) NOT NULL,
    CONSTRAINT [PK_TransformFactFinancialOther__FinancialOtherID_TenantID] PRIMARY KEY CLUSTERED ([FinancialOtherID] ASC, [TenantID] ASC)
);


GO
PRINT N'Creating [Transform].[FactHCAMetric]...';
...
CREATE TABLE [Transform].[FactHCAMetric] (
    ...
    [UpdatedDateTime]  DATETIME       NULL,
    [Hashvalue]        NVARCHAR (64)  NOT NULL,
    CONSTRAINT [PK_TransformHCAMetric__HCAMetricID_TenantID] PRIMARY KEY CLUSTERED ([HCAMetricID] ASC, [TenantID] ASC)
);
...
GO
PRINT N'Creating [DW].[FK_DWFactFinancialOther_Tenant__TenantID]...';


GO
ALTER TABLE [DW].[FactFinancialOther] WITH NOCHECK
    ADD CONSTRAINT [FK_DWFactFinancialOther_Tenant__TenantID] FOREIGN KEY ([TenantID]) REFERENCES [dbo].[Tenant] ([TenantID]);


GO
PRINT N'Creating [DW].[FK_DWFactHCAMetric_Tenant__TenantID]...';


GO
ALTER TABLE [DW].[FactHCAMetric] WITH NOCHECK
    ADD CONSTRAINT [FK_DWFactHCAMetric_Tenant__TenantID] FOREIGN KEY ([TenantID]) REFERENCES [dbo].[Tenant] ([TenantID]);


GO
PRINT N'Creating [Transform].[FK_TransformFactFinancialOther_Tenant__TenantID]...';


GO
ALTER TABLE [Transform].[FactFinancialOther] WITH NOCHECK
    ADD CONSTRAINT [FK_TransformFactFinancialOther_Tenant__TenantID] FOREIGN KEY ([TenantID]) REFERENCES [dbo].[Tenant] ([TenantID]);


GO
PRINT N'Creating [Transform].[FK_TransformFactHCAMetric_Tenant__TenantID]...';


GO
ALTER TABLE [Transform].[FactHCAMetric] WITH NOCHECK
    ADD CONSTRAINT [FK_TransformFactHCAMetric_Tenant__TenantID] FOREIGN KEY ([TenantID]) REFERENCES [dbo].[Tenant] ([TenantID]);
...
AS
	...
	;	
     ...
     RETURN 0;
GO
PRINT N'Creating [dbo].[usp_Dashboard-Averages]...';
...
GO
PRINT N'Creating [dbo].[usp_Dashboard-WeeklyBudget]...';
...
GO
PRINT N'Creating [DW].[usp_Dashboard-56weekAttendance]...';
...
ORDER BY 1,2;
GO
PRINT N'Creating [DW].[usp_Dashboard-ContributionsAttendancePercent]...';
...
INNER JOIN TotalAttendance
	ON 1=1
GO
PRINT N'Creating [DW].[usp_Dashboard-MonthAverageAttendance]...';
...
ORDER BY
	1, 2;
GO
PRINT N'Refreshing [DW].[usp_Dashboard-ActualRevenueVActualExpense]...';


GO
EXECUTE sp_refreshsqlmodule N'[DW].[usp_Dashboard-ActualRevenueVActualExpense]';


GO
PRINT N'Refreshing [DW].[usp_Dashboard-ActualVBudgetedExpense]...';


GO
EXECUTE sp_refreshsqlmodule N'[DW].[usp_Dashboard-ActualVBudgetedExpense]';


GO
PRINT N'Refreshing [DW].[usp_Dashboard-ActualVBudgetedRevenue]...';


GO
EXECUTE sp_refreshsqlmodule N'[DW].[usp_Dashboard-ActualVBudgetedRevenue]';


GO
PRINT N'Refreshing [DW].[usp_Dashboard-Contributions]...';


GO
EXECUTE sp_refreshsqlmodule N'[DW].[usp_Dashboard-Contributions]';


GO
PRINT N'Refreshing [DW].[usp_Dashboard-HBFChurchPlants]...';


GO
EXECUTE sp_refreshsqlmodule N'[DW].[usp_Dashboard-HBFChurchPlants]';
...
GO
ALTER TABLE [DW].[FactFinancialOther] WITH CHECK CHECK CONSTRAINT [FK_DWFactFinancialOther_Tenant__TenantID];

ALTER TABLE [DW].[FactHCAMetric] WITH CHECK CHECK CONSTRAINT [FK_DWFactHCAMetric_Tenant__TenantID];

ALTER TABLE [Transform].[FactFinancialOther] WITH CHECK CHECK CONSTRAINT [FK_TransformFactFinancialOther_Tenant__TenantID];

ALTER TABLE [Transform].[FactHCAMetric] WITH CHECK CHECK CONSTRAINT [FK_TransformFactHCAMetric_Tenant__TenantID];
