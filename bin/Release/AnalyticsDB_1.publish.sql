...
GO
PRINT N'Creating [dbo].[CampusXLTReportGroup]...';
...
CREATE TABLE [dbo].[CampusXLTReportGroup] (
    ...
    CONSTRAINT [PK_CampusXLTReportGroup__CampusXLTReportGroupID] PRIMARY KEY CLUSTERED ([CampusXLTReportGroupID] ASC)
);


GO
PRINT N'Creating [dbo].[CampusXLTReportGroupMap]...';
...
GO
PRINT N'Creating [dbo].[CampusXLTReportGroupMap].[CampusXLTReportGroupMap__FinancialCategoryID_CampusXLTReportGroupID]...';


GO
CREATE CLUSTERED INDEX [CampusXLTReportGroupMap__FinancialCategoryID_CampusXLTReportGroupID]
    ON [dbo].[CampusXLTReportGroupMap]([FinancialCategoryID] ASC, [CampusXLTReportGroupID] ASC);


GO
PRINT N'Creating [dbo].[Paycor_MIP_Mapping]...';


GO
CREATE TABLE [dbo].[Paycor_MIP_Mapping] (
    [GLOrgCode]       NVARCHAR (255) NOT NULL,
    [CampusCode]      NVARCHAR (20)  NULL,
    [AccountingCode9] NVARCHAR (20)  NULL,
    [AccountingName9] NVARCHAR (100) NULL,
    CONSTRAINT [PK_PaycorMIPMapping__GLOrgCode_GLAccountNumber] PRIMARY KEY CLUSTERED ([GLOrgCode] ASC)
);


GO
PRINT N'Creating [DW].[FactMPXActivity]...';


GO
CREATE TABLE [DW].[FactMPXActivity] (
    [MPXActivityID]     INT            NOT NULL,
    [TenantID]          INT            NOT NULL,
    [CalendarMonth]     INT            NULL,
    [CalendarYear]      INT            NULL,
    [Country]           NVARCHAR (255) NULL,
    [SourceGroup]       NVARCHAR (255) NULL,
    [PartnerType]       NVARCHAR (255) NULL,
    [EntityCount]       INT            NULL,
    [ActiveCount]       INT            NULL,
    [NewCount]          INT            NULL,
    [ConversionCount]   INT            NULL,
    [ReactivationCount] INT            NULL,
    [TransactionCount]  INT            NULL,
    [TransactionValue]  DECIMAL (9, 2) NULL,
    [ExecutionID]       VARCHAR (50)   NOT NULL,
    [InsertedDateTime]  DATETIME       NULL,
    [UpdatedDateTime]   DATETIME       NULL,
    [Hashvalue]         NVARCHAR (64)  NOT NULL,
    CONSTRAINT [pk_DWFactMPXActivity__MPXActivityID_TenantID] PRIMARY KEY CLUSTERED ([MPXActivityID] ASC, [TenantID] ASC)
);


GO
PRINT N'Creating [Extract].[MPX_Activity]...';
...
CREATE TABLE [Extract].[MPX_Activity] (
    ...
    [Active]           INT            NULL,
    [ChgDate]          DATE           NULL,
    [SourceCodeValue]  NVARCHAR (255) NULL,
    [PartnerCodeValue] NVARCHAR (255) NULL,
    [TransactionDate]  DATE           NULL,
    [MotivationCode]   NVARCHAR (255) NULL,
    [MediaCode]        NVARCHAR (255) NULL,
    [Amount]           DECIMAL (9, 2) NULL,
    [MaxExtractDate]   DATE           NULL,
    [TenantID]         INT            NOT NULL,
    [ExecutionID]      VARCHAR (50)   NOT NULL,
    [InsertedDateTime] DATETIME       NULL
);
...
GO
PRINT N'Creating [Extract].[MPX_Activity].[CIX_ExtractMPXActivity_ExecutionID]...';


GO
CREATE CLUSTERED INDEX [CIX_ExtractMPXActivity_ExecutionID]
    ON [Extract].[MPX_Activity]([ExecutionID] ASC);


GO
PRINT N'Creating [Transform].[FactMPXActivity]...';
...
CREATE TABLE [Transform].[FactMPXActivity] (
    ...
    [UpdatedDateTime]   DATETIME       NULL,
    [Hashvalue]         NVARCHAR (64)  NOT NULL,
    CONSTRAINT [PK_TransformMPXActivity__MPXActivityID_TenantID] PRIMARY KEY CLUSTERED ([MPXActivityID] ASC, [TenantID] ASC)
);
...
GO
PRINT N'Creating [DW].[FK_DWFactMPXActivity_Tenant__TenantID]...';


GO
ALTER TABLE [DW].[FactMPXActivity] WITH NOCHECK
    ADD CONSTRAINT [FK_DWFactMPXActivity_Tenant__TenantID] FOREIGN KEY ([TenantID]) REFERENCES [dbo].[Tenant] ([TenantID]);


GO
PRINT N'Creating [Transform].[FK_TransformFactMPXActivity_Tenant__TenantID]...';


GO
ALTER TABLE [Transform].[FactMPXActivity] WITH NOCHECK
    ADD CONSTRAINT [FK_TransformFactMPXActivity_Tenant__TenantID] FOREIGN KEY ([TenantID]) REFERENCES [dbo].[Tenant] ([TenantID]);
...
USING (VALUES
  ...
  , (9, N'Data Source=localhost;User ID=sa;Password=C4lr1ss14n;Initial Catalog=MPXWIWU;Provider=SQLNCLI11.1;Auto Translate=False;', 'InfiniteCampus', -1, GETDATE(), GETDATE(), '')
  , (10, N'Data Source=localhost;User ID=sa;Password=C4lr1ss14n;Initial Catalog=MPXWIWC;Provider=SQLNCLI11.1;Auto Translate=False;', 'InfiniteCampus', -1, GETDATE(), GETDATE(), '')
)
...
GO
ALTER TABLE [DW].[FactMPXActivity] WITH CHECK CHECK CONSTRAINT [FK_DWFactMPXActivity_Tenant__TenantID];

ALTER TABLE [Transform].[FactMPXActivity] WITH CHECK CHECK CONSTRAINT [FK_TransformFactMPXActivity_Tenant__TenantID];
